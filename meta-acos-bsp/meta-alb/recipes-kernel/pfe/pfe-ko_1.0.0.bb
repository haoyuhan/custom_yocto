...
SRC_URI:append = " \
	file://${PFE_FW_CLASS_BIN} \
	file://${PFE_FW_UTIL_BIN} \
"
SRC_URI += "file://0001_s32g_pfeng_ptp_ref_clock.patch"
...
module_do_install() {
	...
	install -D "${WORKDIR}/${PFE_FW_CLASS_BIN}" "${FW_INSTALL_DIR}/${FW_INSTALL_CLASS_NAME}"
	install -D "${WORKDIR}//${PFE_FW_UTIL_BIN}" "${FW_INSTALL_DIR}/${FW_INSTALL_UTIL_NAME}"
}
