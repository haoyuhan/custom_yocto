...
ACOS_BASE_IMAGE ?= "core-image"

inherit ${ACOS_BASE_IMAGE}
FEATURE_PACKAGES_selinux = " \
    packagegroup-acos-core-selinux \
    ${@bb.utils.contains('DISTRO_FEATURES', 'ac-devel', 'packagegroup-ac-core-selinux-devel', '', d)} \
"
